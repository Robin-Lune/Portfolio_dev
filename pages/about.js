...
import autoPortrait from "/public/images/photoBio.webp";
    ...
    <section className="about-container">
      ...
      <Parallax speed={-5} className="image_bio_container" >
        ...
        <div className="image_bio_container__2">
          ...
          <Image src={autoPortrait} alt='Autoportrait de Robin dans son environnement de travail' layout="responsive" objectFit="cover" placeholder="blur"/>
